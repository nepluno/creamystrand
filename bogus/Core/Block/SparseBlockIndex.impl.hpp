...
template <typename Derived>
typename SparseBlockIndexBase<Derived>::Index
SparseBlockIndexBase<Derived>::innerSize() const {
  return innerOffsetsArray().size() - 1;
}

template <typename Derived>
typename SparseBlockIndexBase<Derived>::Index
SparseBlockIndexBase<Derived>::outerSize() const {
  return derived().outerSize();
}

template <typename Derived>
const typename SparseBlockIndexBase<Derived>::InnerOffsetsType&
SparseBlockIndexBase<Derived>::innerOffsetsArray() const {
...
template <typename Derived>
typename SparseBlockIndexBase<Derived>::Index
SparseBlockIndexBase<Derived>::size(Index outerIdx) const {
  return derived().size(outerIdx);
}

template <typename Derived>
typename SparseBlockIndexBase<Derived>::InnerIterator
SparseBlockIndexBase<Derived>::begin(Index outerIdx) const {
  return InnerIterator(*this, outerIdx);
}

template <typename Derived>
typename SparseBlockIndexBase<Derived>::InnerIterator
SparseBlockIndexBase<Derived>::end(Index outerIdx) const {
  return InnerIterator(*this, outerIdx).toEnd();
}

template <typename Derived>
typename SparseBlockIndexBase<Derived>::InnerIterator
SparseBlockIndexBase<Derived>::last(Index outerIdx) const {
...
SparseBlockIndex<Compressed, Index, BlockPtr, ArrayType>&
SparseBlockIndex<Compressed, Index, BlockPtr, ArrayType>::operator=(
