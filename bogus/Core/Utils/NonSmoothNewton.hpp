...
class NonSmoothNewton {
 public:
  ...
  /*! Or, more precisely, such that \f[ \Phi(x) = \frac 1 2 \vert f(x) \vert_2^2
     < tol \f] \param x Used both as an initial guess and to return the
     approximate solution \return \f$ \Phi(x) \f$
  */
