...
template <typename Archive, typename _Scalar, int _Rows, int _Cols,
...
template <typename Archive, typename _Scalar, int _Cols, int _Options,
          int _MaxRows, int _MaxCols>
inline void load(Archive& ar,
                 Eigen::Matrix<_Scalar, Eigen::Dynamic, _Cols, _Options,
...
template <typename Archive, typename _Scalar, int _Cols, int _Options,
          int _MaxRows, int _MaxCols>
inline void save(Archive& ar,
                 const Eigen::Matrix<_Scalar, Eigen::Dynamic, _Cols, _Options,
                                     _MaxRows, _MaxCols>& matrix,
                 const unsigned int file_version) {
  (void)file_version;
...
template <typename Archive, typename _Scalar, int _Rows, int _Options,
          int _MaxRows, int _MaxCols>
inline void load(Archive& ar,
                 Eigen::Matrix<_Scalar, _Rows, Eigen::Dynamic, _Options,
                               _MaxRows, _MaxCols>& matrix,
                 const unsigned int file_version) {
  (void)file_version;
  int cols;
...
template <typename Archive, typename _Scalar, int _Rows, int _Options,
          int _MaxRows, int _MaxCols>
inline void save(Archive& ar,
                 const Eigen::Matrix<_Scalar, _Rows, Eigen::Dynamic, _Options,
                                     _MaxRows, _MaxCols>& matrix,
                 const unsigned int file_version) {
  (void)file_version;
...
template <typename Archive, typename _Scalar, int _Options, int _MaxRows,
          int _MaxCols>
inline void load(Archive& ar,
...
template <typename Archive, typename _Scalar, int _Options, int _MaxRows,
          int _MaxCols>
inline void save(Archive& ar,
                 const Eigen::Matrix<_Scalar, Eigen::Dynamic, Eigen::Dynamic,
                                     _Options, _MaxRows, _MaxCols>& matrix,
                 const unsigned int file_version) {
  (void)file_version;
