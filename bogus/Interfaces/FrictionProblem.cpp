...
double DualFrictionProblem< Dimension >::solveWith( GaussSeidelType &gs, double *r,
                                         const bool staticProblem, const bool herschelBulkleyProblem ) const
{
	gs.setMatrix( W );

	return friction_problem::solve( *this, gs, r, staticProblem, herschelBulkleyProblem ) ;
}

template< unsigned Dimension >
double DualFrictionProblem< Dimension >::solveWith( ProjectedGradientType &pg,
                                                    double *r, const bool staticProblem, const bool herschelBulkleyProblem ) const
{
	pg.setMatrix( W );

	return friction_problem::solve( *this, pg, r, staticProblem, herschelBulkleyProblem ) ;
}
...
double DualFrictionProblem< Dimension >::evalWith( const GaussSeidelType &gs,
                                                     ...
                                                     const bool staticProblem, const bool herschelBulkleyProblem ) const
{
	return friction_problem::eval( *this, gs, r, staticProblem, herschelBulkleyProblem ) ;
}

template< unsigned Dimension >
double DualFrictionProblem< Dimension >::evalWith( const ProjectedGradientType &gs,
                                                   const double *r, const bool staticProblem, const bool herschelBulkleyProblem ) const
{
	return friction_problem::eval( *this, gs, r, staticProblem, herschelBulkleyProblem) ;
}
