...
struct DualFrictionProblem
{
	...
	/*!
	  ...
	  */
	double solveWith( GaussSeidelType &gs, double * r, const bool staticProblem = false, const bool herschelBulkleyProblem = false ) const ;
	//! Same as above
	/*! \warning staticProblem defaults tp true (as solving Coulomb probles with PG is unreliable)*/
	double solveWith( ProjectedGradientType &pg, double * r, const bool staticProblem = true, const bool herschelBulkleyProblem = false ) const ;
	...
	/*!
	  ...
	  */
	double evalWith( const GaussSeidelType &gs, const double * r, const bool staticProblem = false, const bool herschelBulkleyProblem = false ) const ;
	//! Same as above
	/*! \warning staticProblem defaults tp true (as solving Coulomb probles with PG is unreliable)*/
	double evalWith( const ProjectedGradientType &gs, const double * r, const bool staticProblem = true, const bool herschelBulkleyProblem = false ) const ;
