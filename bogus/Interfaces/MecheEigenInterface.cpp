...
namespace bogus
{
	...
	void MecheFrictionProblem::computeDual(double regularization, bool diagonalProblem)
	{
		delete m_dual;
	...
	)
	{
		...
		return solve(r, v, r_world, options, staticProblem, herschelBulkleyProblem, doFrictionShrinking, problemRegularization, diagonalProblem);
	}
