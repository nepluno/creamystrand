...
namespace strandsim
{
	...
	{
	public:
		AreaDOFs( const VecXx& dofValues ) :
    ...
    public:
        ...
        DependencyNode<std::vector<Scalar> >( 0, jump_edges.size() ), m_jump_edges( jump_edges )
        {
	...
	public:
		...
		DependencyNode<std::vector<Scalar> >( 0, lengths.size() + 1 ), m_lengths( lengths )
		{
		...
		virtual const char* name() const
		{
			return "Dynamic Voronoi Lengths";
		}
	...
	public:
		...
		DependencyNode<std::vector<Scalar> >( 0, lengths.size() ), m_voronoi_lengths( lengths ), m_heights( height )
		{
	...
	public:
		...
		DependencyNode<Vec3xArray>( 0, edges.size() ), m_edges( edges ), m_lengths( lengths )
		{
			m_edges.addDependent( this );
			m_lengths.addDependent( this );
		}
	...
	public:
		...
		DependencyNode<std::pair<VecXx, VecXx> >( std::make_pair( VecXx(), VecXx() ) ), m_dofs(
																							   dofs )
		{
			m_dofs.addDependent( this );
		}
