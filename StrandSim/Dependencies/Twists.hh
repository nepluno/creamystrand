...
public:
    GradTwists( Lengths& lengths, CurvatureBinormals& curvatureBinormals ) :
            DependencyNode<Vec11xArray>( 1, lengths.size() ), m_lengths( lengths ), m_curvatureBinormals(
                    curvatureBinormals )
    {
...
public:
    GradTwistsSquared( GradTwists& gradTwists ) :
            DependencyNode<Mat11xArray>( 1, gradTwists.size() ), m_gradTwists( gradTwists )
    {
...
public:
    HessTwists( Tangents&tangents, Lengths& lengths, CurvatureBinormals& curvatureBinormals ) :
            DependencyNode<Mat11xArray>( 1, lengths.size() ), m_tangents( tangents ), m_lengths(
