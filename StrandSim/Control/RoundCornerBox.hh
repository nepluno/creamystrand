...
protected:
	...
	double m_radius;
	int m_N_edge;
	inline void AddVertex(int i, int j, int k, const Vec3x& pos, const Vec3x& base_pos)
	{
...
public:
	RoundCornerBox(int N, const Vec3x& b, const double& radius, strandsim::TriangularMesh* mesh, bool inverted);
};
};
