...
namespace strandsim
{
    ...
    public:
        ObjParser() {};
        ObjParser(const std::string& obj_file_name, TriangularMesh* mesh, bool inverted);
        /**
         ...
         */
        bool loadTriangularMesh( const std::string& obj_file_name, TriangularMesh& tri_mesh, bool inverted = false );
    private:
    ...
    {
    public:
        bool loadParticles( const std::string& coff_file_name, std::vector<Vec3x>& particles );
    };
    ...
    {
    public:
        bool writeArray3( const std::string& array_file_name, const bridson::Array3<S, bridson::Array1<S> >& arr );
        bool writeArray3( const std::string& array_file_name, const std::vector<S>& arr, int ni, int nj, int nk );
    };
}
