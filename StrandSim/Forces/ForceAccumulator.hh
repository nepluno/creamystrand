...
public:
    ...
    static void accumulateMultipliers( VecXx& multipliers, const ElasticStrand& strand )
    {
...
//        assert( state.m_framesUpToDate );
    ...
    static void accumulate( JacobianMatrixType& Jacobian, const ElasticStrand& strand,
             StrandState& state )
    {
//        assert( state.m_framesUpToDate );
