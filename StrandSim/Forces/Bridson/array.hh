...
struct Array
{
   ...
   void reserve(int nx_, int ny_, int nz_)
   { a.reserve(nx_*ny_*nz_); }
...
//typedef Array<bool>           Arrayb; NOTE: this doesn't work as intended since std::vector<bool> is specialized
