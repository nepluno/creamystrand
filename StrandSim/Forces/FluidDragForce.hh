...
namespace strandsim {
    ...
    public:
        ...
        static void setScriptingController(const std::shared_ptr<FluidScriptingController>& controller);
        ...
        static Scalar computeLocal( LocalForceType& localF,
                                   const Vec3x& edge,
                                   const Vec3x& u_s0,
                                   const Vec3x& u_s,
                                   const Vec3x& u_f,
