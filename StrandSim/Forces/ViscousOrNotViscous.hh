...
public:
	...
	{
		return strand.m_parameters.getKs( vtx, strand.getNumVertices() ) * strand.m_parameters.getMinBendingMultiplier();
	}
...
public:
    ...
    static Scalar bendingCoefficient( const ElasticStrand& strand, int vtx )
    {
        return strand.m_parameters.viscousBendingCoefficient( vtx, strand.getNumVertices() );
    }

    static Mat2x bendingMatrix( const ElasticStrand& strand, int vtx )
    {
        return strand.m_parameters.viscousBendingMatrix( vtx, strand.getNumVertices() );
    }
	...
	static Scalar kmb( const ElasticStrand& strand, int vtx )
	{
		return strand.m_parameters.getViscousKs( vtx, strand.getNumVertices() ) * strand.m_parameters.getMinBendingMultiplier();
	}
