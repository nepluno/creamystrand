...
namespace strandsim {
    ...
    public:
        ...
        Scalar interpolate_table(const Scalar& A, const Scalar& d0, const MatXx& mat, const Scalar& dmin) const;
        Scalar interpolate_table_planar(const Scalar& A, const Scalar& d0, const MatXx& mat, const Scalar& dmin) const;
        Scalar interpolate_table_grad(const Scalar& A, const Scalar& d0, const MatXx& mat, const Scalar& dmin) const;
        Scalar interpolate_table_grad_planar(const Scalar& A, const Scalar& d0, const MatXx& mat, const Scalar& dmin) const;
        ...
        void print_table(std::ostream& oss, const MatXx& mat, const Scalar& dmin) const;
